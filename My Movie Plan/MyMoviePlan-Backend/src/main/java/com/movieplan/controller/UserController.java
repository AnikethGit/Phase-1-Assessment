...
import com.movieplan.entities.Role;
import com.movieplan.entities.User;
import com.movieplan.entities.UserRole;
...
public class UserController {
	...
	public void createAdmin(){
		User admin = new User();
		admin.setUsername("admin@mymovieplan.com");
		admin.setPassword("admin12345");
		admin.setFirstName("Aniketh");
		admin.setLastName("Sahu");
		admin.setContactNumber("9865426173");
		Role role = new Role();
		role.setRoleId(101L);
