...
<%
BookingDetails.flight_booking_id = request.getParameter("flight_id");
BookingDetails.ticket_price = Integer.parseInt(request.getParameter("ticket_price"));
BookingDetails.flight_name = request.getParameter("flight_name");
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <section class="container-fluid bg">
        <section class="row justify-content-center">
            ...
            <section class="col-sm-6 col-md-3">
                <form action="payments.jsp" method="post" class="form-container">
