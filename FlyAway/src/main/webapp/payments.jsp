...
<%
BookingDetails.passenger_name = request.getParameter("pname");
BookingDetails.passenger_email= request.getParameter("email");
BookingDetails.passenger_phone= request.getParameter("phone");

    if (BookingDetails.passenger_name.equals("")
            || BookingDetails.passenger_email.equals("")
            || BookingDetails.passenger_phone.equals("")) {
    ...
    <section class="container-fluid bg">
        <section class="row justify-content-center">
           ...
           <section class="col-sm-6 col-md-3">
               <form action="thank_you.jsp" method="post" class="form-container">
                   ...
                   <br>
                   <p align="left"><span><strong>Total fare = <br> <%=BookingDetails.ticket_price%> X <%=SearchAlgo.persons%> persons = Rs.<%=BookingDetails.ticket_price*SearchAlgo.persons%></strong></span></p>
